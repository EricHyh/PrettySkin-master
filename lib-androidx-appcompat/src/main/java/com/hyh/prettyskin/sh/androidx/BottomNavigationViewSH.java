...
public class BottomNavigationViewSH extends ViewGroupSH {
    ...
    private final Class mStyleableClass = com.google.android.material.R.styleable.class;
    ...
    public BottomNavigationViewSH() {
        super(com.google.android.material.R.attr.bottomNavigationStyle);
    }
            ...
            switch (attrName) {
                ...
                case "itemIconSize": {
                    int size = view.getResources().getDimensionPixelSize(
                            com.google.android.material.R.dimen.design_bottom_navigation_icon_size);
                    bottomNavigationView
