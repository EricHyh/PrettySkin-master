...
public class TextInputLayoutSH extends ViewGroupSH {
    ...
    public TextInputLayoutSH() {
        this(com.google.android.material.R.attr.textInputStyle);
    }
    ...
    public AttrValue parse(View view, AttributeSet set, String attrName) {
        ...
        switch (attrName) {
            ...
            case "boxBackgroundMode": {
                ...
                if (mTypedArray != null) {
                    boxBackgroundMode = mTypedArray.getInt(com.google.android.material.R.styleable.TextInputLayout_boxBackgroundMode, 0);
                }
            ...
            case "passwordToggleTint": {
                ...
                int index = com.google.android.material.R.styleable.TextInputLayout_passwordToggleTint;
            ...
            case "passwordToggleTintMode": {
                ...
                int index = com.google.android.material.R.styleable.TextInputLayout_passwordToggleTintMode;
                if (mTypedArray != null && mTypedArray.hasValue(index)) {
