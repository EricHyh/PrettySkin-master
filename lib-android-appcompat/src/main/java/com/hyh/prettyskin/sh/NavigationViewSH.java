            ...
            switch (attrName) {
                case "itemIconTint": {
                    navigationView.setItemIconTintList(
                            attrValue.getTypedValue(ColorStateList.class, navigationView.getItemIconTintList()));
                    break;
                }
                case "itemTextColor": {
                    navigationView.setItemTextColor(
                            attrValue.getTypedValue(ColorStateList.class, navigationView.getItemTextColor()));
                    break;
                }
                case "itemBackground": {
