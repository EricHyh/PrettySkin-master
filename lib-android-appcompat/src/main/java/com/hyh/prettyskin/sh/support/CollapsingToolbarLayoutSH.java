...
public class CollapsingToolbarLayoutSH extends ViewGroupSH {
    ...
    public void prepareParse(View view, AttributeSet set) {
        ...
        mTypedArray = view.getContext().obtainStyledAttributes(
                set,
                android.support.design.R.styleable.CollapsingToolbarLayout,
                mDefStyleAttr,
    ...
    public AttrValue parse(View view, AttributeSet set, String attrName) {
        ...
        switch (attrName) {
            ...
            case "expandedTitleMargin": {
                ...
                if (mTypedArray != null) {
                    expandedTitleMargin = mTypedArray.getInt(android.support.design.R.styleable.CollapsingToolbarLayout_expandedTitleMargin,
